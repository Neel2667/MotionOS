...
export class RotateNode extends MotionNode {
  constructor() {
    super('RotateNode');
  ...
  execute(context: MotionContext) {
    ...
    if (obj && obj.transform) {
      ...
      obj.transform.rotation.x += (this.parameters.x || 0) * delta * speed;
      obj.transform.rotation.y += (this.parameters.y || 0) * delta * speed;
      obj.transform.rotation.z += (this.parameters.z || 0) * delta * speed;
    }
  }
}
